...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final Index idxWorkoutLogsDate = Index(
    'idx_workout_logs_date',
    'CREATE INDEX idx_workout_logs_date ON workout_logs (date)',
  );
  late final Index idxExerciseSetsLogId = Index(
    'idx_exercise_sets_log_id',
    'CREATE INDEX idx_exercise_sets_log_id ON exercise_sets (log_id)',
  );
  late final Index idxExerciseSetsExerciseName = Index(
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities => [
    ...
    appSettings,
    idxWorkoutLogsDate,
    idxExerciseSetsLogId,
    idxExerciseSetsExerciseName,
  ];
  @override
